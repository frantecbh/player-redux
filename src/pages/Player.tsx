    ...
    <div className="h-screen bg-zinc-950 text-zinc-50 flex justify-center items-center">
      <div className="flex w-6xl flex-col gap-6">
        ...
        <main className="relative flex overflow-hidden rounded-lg border border-zinc-700 bg-zinc-900 shadow pr-80">
          ...
          <aside className="w-80 border-l absolute top-0 bottom-0 right-0  border-zinc-700 bg-zinc-900 overflow-y-scroll scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-zinc-900 divide-y-2 divide-zinc-900">
            <div>
